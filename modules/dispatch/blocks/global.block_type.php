...
if (!nv_function_exists('nv_type_blocks')) {
    ...
    function nv_block_config_type_blocks($module, $data_block, $lang_block)
    {
        ...
        $html .= "	<div class=\"col-sm-18\"><select name=\"config_type\" class=\"form-control w200\">\n";
        ...
        $html .= "	<div class=\"col-sm-18\"><input type=\"text\" name=\"config_numrow\" class=\"form-control w200\" size=\"5\" value=\"" . $data_block['numrow'] . "\"/></div>";
        $html .= "</div>";
        return $html;
    }
