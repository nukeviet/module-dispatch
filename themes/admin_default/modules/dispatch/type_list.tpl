...
<div id="users">
    <table class="table table-striped table-bordered table-hover">
        ...
        <!-- BEGIN: row -->
            <tr>
                <td>
                    <select class="form-control" name="weight" id="weight{ROW.id}" onchange="nv_chang_type_weight({ROW.id});">
                        <!-- BEGIN: weight -->
                ...
                <td  class="text-center">
                    ...
                    <em class="fa fa-trash-o fa-lg">&nbsp;</em><a href="javascript:void(0);" onclick="nv_type_del({ROW.id});">{GLANG.delete}</a>
                </td>
            </tr>
        <!-- END: row -->
        <tbody>
